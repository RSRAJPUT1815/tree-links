    ...
    return (
      <div className="min-h-screen bg-[#254f1a]  text-gray-800 px-6 py-12  md:px-20 lg:px-40">
        ...
        <section className="mt-10">
          <h2 className="text-2xl font-semibold mb-4">Why LinkTree?</h2>
        ...
        <section className="text-center">
          ...
          <p className="text-lg mb-6">
            ...
            LinkTree is here to simplify how you connect, curate, and grow your digital presence.
          </p>
          <a
            href="/"
